...
enum WorldDatabaseStatements : uint32
{
    ...
    */
    ...
    WORLD_SEL_CREATURE_POS_BY_ID,
    WORLD_SEL_CREATURE_COUNT_BY_ID,
    ...
    */
    ...
    WORLD_SEL_WAYPOINT_INFO,
    WORLD_SEL_WAYPOINT_INFO_BY_ID,
    WORLD_SEL_WAYPOINT_PATH_DIRECTION,
    WORLD_SEL_WAYPOINT_PATH_TYPE,
    WORLD_REP_WAYPOINT_PATH_DIRECTION,
    WORLD_REP_WAYPOINT_PATH_TYPE,

    WORLD_SEL_ITEM_EXTENDED_COST,
