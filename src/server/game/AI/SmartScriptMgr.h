...
enum SMARTAI_TARGETS
{
    ...
    //SMART_TARGET_ACTION_INVOKER_VEHICLE         = 22,   // Unit's vehicle who caused this Event to occur, disable for TBC
    ...
    //SMART_TARGET_VEHICLE_PASSENGER              = 29,   // seatMask (0 - all seats), disable for TBC
