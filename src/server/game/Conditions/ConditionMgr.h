...
{                                                           // value1           value2         value3
    ...
    CONDITION_TERRAIN_SWAP          = 41,                   //                                                    only master branch
...
enum ConditionSourceType
{
    ...
    CONDITION_SOURCE_TYPE_MILLING_LOOT_TEMPLATE          = 7, //LK only
    ...
    CONDITION_SOURCE_TYPE_VEHICLE_SPELL                  = 21, //LK only
    CONDITION_SOURCE_TYPE_SMART_EVENT                    = 22,
    CONDITION_SOURCE_TYPE_NPC_VENDOR                     = 23,
    CONDITION_SOURCE_TYPE_SPELL_PROC                     = 24,
    CONDITION_SOURCE_TYPE_TERRAIN_SWAP                   = 25, // TC only master branch
    CONDITION_SOURCE_TYPE_PHASE                          = 26, // TC only master branch
    CONDITION_SOURCE_TYPE_GRAVEYARD                      = 27, // TC only master branch
