...
/*
Those CreatureDifficultyFlags are from Legion TrinityCore. The DB data we have for them is from MoP retail.
We currently use very few of them
*/
...
enum CreatureDifficultyFlags2
{
    ...
    CREATURE_DIFFICULTYFLAGS_2_NO_DEFAULT_PET_BAR              = 0x00400000, // sun: guessed
...
struct CreatureDifficultyFlagsData
{
    uint32 Flags1 = 0;
    uint32 Flags2 = 0;
    uint32 Flags3 = 0;
...
struct CreatureTemplate
{
    ...
    CreatureDifficultyFlagsData  DifficultyFlags;
    bool    RacialLeader;
    float   ModHealth;
    float   ModMana;
    float   ModArmor;
