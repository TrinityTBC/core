...
class TC_GAME_API WorldObject : public Object, public WorldLocation
{
    public:
        ...
        */
        ...
        virtual void SendMessageToSetInRange(WorldPacket const* data, float dist, bool self, bool includeMargin = false, Player const* skipped_rcvr = nullptr) const;
        virtual void SendMessageToSet(WorldPacket const* data, Player* skipped_rcvr) const;
		...
		TempSummon* SummonCreature(uint32 id, Position const& pos, TempSummonType spwtype = TEMPSUMMON_MANUAL_DESPAWN, uint32 despwtime = 0);
        ...
        GameObject* SummonGameObject(uint32 entry, Position const& pos, QuaternionData const& rot, uint32 respawnTime, GOSummonType summonType = GO_SUMMON_TIMED_OR_CORPSE_DESPAWN);
