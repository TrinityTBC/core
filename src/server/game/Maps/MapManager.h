...
class TC_GAME_API MapManager
{
    ...
    public:
        ...
        std::pair<TestMap*, uint32 /*testMapInstanceId*/> CreateTestMap(std::weak_ptr<TestThread>&, uint32 mapid, Difficulty diff = REGULAR_DIFFICULTY, bool enableMapObjects = false);
