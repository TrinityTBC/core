...
#else
        static void SendMovementFlagChangeToObservers(Unit* unit, MovementFlags2 mFlag) = delete;
        static void SendMovementFlagChangeToMover(Unit* unit, MovementFlags2 mFlag, bool apply) = delete;
#endif
