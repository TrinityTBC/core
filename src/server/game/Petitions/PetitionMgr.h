...
class TC_GAME_API PetitionMgr
{
    public:
        ...
        void RemovePetitionsByOwnerAndType(SQLTransaction trans, ObjectGuid ownerGuid, CharterTypes type);
        void RemoveSignaturesBySignerAndType(SQLTransaction trans, ObjectGuid signerGuid, CharterTypes type);
};
