...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "addon",          SEC_GAMEMASTER3,          true, &HandleAccountSetAddonCommand,     "" },
        ...
        static std::vector<ChatCommand> accountCommandTable =
        {
            ...
            { "mailchange",     SEC_GAMEMASTER2,    true,  &HandleAccountMailChangeCommand,        "" },
    ...
    static bool HandleAccountSetGmLevelCommand(ChatHandler* handler, char const* args)
    {
        ...
        //rbac = isAccountNameGiven ? NULL : handler->GetSelectedPlayer()->GetSession()->GetRBACData(); //TODO RBAC
