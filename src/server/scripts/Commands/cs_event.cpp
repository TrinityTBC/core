...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "activelist",     SEC_GAMEMASTER2,     true, &HandleEventActiveListCommand,     "" },
            { "start",          SEC_GAMEMASTER2,     true, &HandleEventStartCommand,          "" },
            { "stop",           SEC_GAMEMASTER2,     true, &HandleEventStopCommand,           "" },
            { "create",         SEC_GAMEMASTER2,     true, &HandleEventCreateCommand,         "" },
            { "info",           SEC_GAMEMASTER2,     true, &HandleEventInfoCommand,           "" },
        };
