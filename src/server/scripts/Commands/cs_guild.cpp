...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "create",         SEC_GAMEMASTER2,     true, &HandleGuildCreateCommand,                    "" },
            { "delete",         SEC_GAMEMASTER2,     true, &HandleGuildDeleteCommand,                    "" },
            { "invite",         SEC_GAMEMASTER2,     true, &HandleGuildInviteCommand,                    "" },
            { "uninvite",       SEC_GAMEMASTER2,     true, &HandleGuildUninviteCommand,                  "" },
            { "rank",           SEC_GAMEMASTER2,     true, &HandleGuildRankCommand,                      "" },
            { "rename",         SEC_GAMEMASTER2,     true, &HandleGuildRenameCommand,                    "" },
        };
