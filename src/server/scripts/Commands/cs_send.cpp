...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "mail",       SEC_GAMEMASTER3,  true,  &HandleSendMailCommand,         "" },
            { "message",    SEC_GAMEMASTER3,  true,  &HandleSendMessageCommand,      "" },
            { "items",      SEC_GAMEMASTER3,  true,  &HandleSendItemsCommand,        "" },
            { "money",      SEC_GAMEMASTER3,  true,  &HandleSendMoneyCommand,        "" },
        };
        static std::vector<ChatCommand> commandTable =
        {
            { "send",       SEC_GAMEMASTER3,  false, nullptr,                        "", sendCommandTable },
        };
        return commandTable;
    }
