...
public:
    ...
    struct npc_kerlonianAI : public ScriptedFollowerAI
    {
        npc_kerlonianAI(Creature* creature) : ScriptedFollowerAI(creature)
        {
            Initialize();
        }
        ...
        {
            ScriptedFollowerAI::MoveInLineOfSight(who);
...
public:
    ...
    struct npc_threshwackonatorAI : public ScriptedFollowerAI
    {
        npc_threshwackonatorAI(Creature* creature) : ScriptedFollowerAI(creature) { }
