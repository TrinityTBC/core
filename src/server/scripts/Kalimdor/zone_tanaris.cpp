...
public:
    ...
    struct npc_toogaAI : public ScriptedFollowerAI
    {
        npc_toogaAI(Creature* creature) : ScriptedFollowerAI(creature)
        {
            Initialize();
        }
        ...
        {
            ScriptedFollowerAI::MovementInform(MotionType, PointId);
